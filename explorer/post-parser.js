...
(function(root) {
  ...
  function peg$parse(input, options) {
    ...
    var peg$FAILED = {},
        ...
        peg$c17 = function(head, tail) { return [ head ].concat( tail ).join('')  },
        ...
        peg$c22 = function(s, ts, e) { return s.name === e.name },
        peg$c23 = function(s, ts, e) { return {
            type: 'HTML_Tag',
            name: s.name,
            attrs: s.attrs,
            startText: s.text,
        ...
        peg$c32 = function(cs) { return cs.join('') },
