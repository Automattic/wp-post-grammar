...
var _user$project$Style$noHighlight = _rtfeldman$elm_css$Css$mixin(
	{
		ctor: '::',
		_0: _rtfeldman$elm_css$Css$color(
			A3(_rtfeldman$elm_css$Css$rgb, 208, 208, 208)),
		_1: {ctor: '[]'}
	});
var _user$project$Style$outputPane = {
	ctor: '::',
...
var _user$project$Style$layout = {
	ctor: '::',
...
var _user$project$Style$inputPane = {
	ctor: '::',
...
var _user$project$Style$green = A3(_rtfeldman$elm_css$Css$rgb, 0, 128, 0);
var _user$project$Style$red = A3(_rtfeldman$elm_css$Css$rgb, 200, 0, 0);
var _user$project$Style$ns = 'wppg';
var _user$project$Style$_p0 = _rtfeldman$elm_css_helpers$Html_CssHelpers$withNamespace(_user$project$Style$ns);
var _user$project$Style$class = _user$project$Style$_p0.$class;
var _user$project$Style$ParseGood = {ctor: 'ParseGood'};
var _user$project$Style$ParseBad = {ctor: 'ParseBad'};
var _user$project$Style$OutputPane = {ctor: 'OutputPane'};
var _user$project$Style$NoHighlight = {ctor: 'NoHighlight'};
var _user$project$Style$Layout = {ctor: 'Layout'};
var _user$project$Style$InputPane = {ctor: 'InputPane'};
var _user$project$Style$css = function (_p1) {
	return _rtfeldman$elm_css$Css$stylesheet(
		A2(_rtfeldman$elm_css$Css_Namespace$namespace, _user$project$Style$ns, _p1));
}(
	{
		ctor: '::',
			...
			_1: {
				...
				_1: {
					...
					_0: A2(
						...
						_user$project$Style$NoHighlight,
						{
							ctor: '::',
							_0: _user$project$Style$noHighlight,
							_1: {
								ctor: '::',
					...
					_1: {
						...
						_0: A2(
							...
							_user$project$Style$OutputPane,
							_user$project$Style$outputPane),
						_1: {
							ctor: '::',
							_0: A2(
								...
								_user$project$Style$ParseBad,
								{
									ctor: '::',
									_0: _rtfeldman$elm_css$Css$color(_user$project$Style$red),
									_1: {ctor: '[]'}
								}),
							_1: {
								ctor: '::',
								_0: A2(
									...
									_user$project$Style$ParseGood,
									{
										ctor: '::',
										_0: _rtfeldman$elm_css$Css$color(_user$project$Style$green),
										_1: {ctor: '[]'}
									}),
								_1: {ctor: '[]'}
							}
...
var _user$project$Explorer$submitPost = _elm_lang$core$Native_Platform.outgoingPort(
	'submitPost',
	function (v) {
		return v;
	});
var _user$project$Explorer$receiveParse = _elm_lang$core$Native_Platform.incomingPort('receiveParse', _elm_lang$core$Json_Decode$string);
var _user$project$Explorer$Model = F3(
	function (a, b, c) {
		return {input: a, parse: b, status: c};
	});
var _user$project$Explorer$ReceiveParse = function (a) {
	return {ctor: 'ReceiveParse', _0: a};
};
var _user$project$Explorer$subscriptions = function (model) {
	return _user$project$Explorer$receiveParse(_user$project$Explorer$ReceiveParse);
};
var _user$project$Explorer$UpdateInput = function (a) {
	return {ctor: 'UpdateInput', _0: a};
};
var _user$project$Explorer$ParseBad = {ctor: 'ParseBad'};
var _user$project$Explorer$ParseGood = {ctor: 'ParseGood'};
var _user$project$Explorer$update = F2(
	function (msg, model) {
		var _p1 = msg;
		if (_p1.ctor === 'UpdateInput') {
			var _p2 = _p1._0;
			return {
				ctor: '_Tuple2',
				_0: _elm_lang$core$Native_Utils.update(
					model,
					{input: _p2, status: _user$project$Explorer$ParseBad}),
				_1: _user$project$Explorer$submitPost(_p2)
			};
		} else {
			var _p4 = _p1._0;
			var _p3 = _p4;
			if (_p3 === '') {
				...
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{parse: _p4, status: _user$project$Explorer$ParseGood}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			}
		}
...
var _user$project$Explorer$statusMessage = function (status) {
	var _p5 = status;
	if (_p5.ctor === 'ParseGood') {
		return A2(
			_elm_lang$html$Html$div,
			{
				ctor: '::',
				_0: _user$project$Style$class(
					{
						ctor: '::',
						_0: _user$project$Explorer$ParseGood,
						_1: {ctor: '[]'}
					}),
				_1: {ctor: '[]'}
			},
			{
				ctor: '::',
				_0: _elm_lang$html$Html$text('Complete parse'),
				_1: {ctor: '[]'}
			});
	} else {
		return A2(
			_elm_lang$html$Html$div,
			{
				...
				_0: _user$project$Style$class(
					{
						ctor: '::',
						_0: _user$project$Explorer$ParseBad,
						_1: {ctor: '[]'}
					}),
				_1: {ctor: '[]'}
			},
			{
				ctor: '::',
				_0: _elm_lang$html$Html$text('No valid parse'),
				_1: {ctor: '[]'}
			});
	}
};
var _user$project$Explorer$view = function (_p6) {
	var _p7 = _p6;
	var _p8 = _p7.status;
	return A2(
		_elm_lang$html$Html$div,
					...
					_0: _elm_lang$html$Html_Attributes$style(
						{
							...
							_1: {
								ctor: '::',
								_0: {ctor: '_Tuple2', _0: 'min-width', _1: '50%'},
								_1: {ctor: '[]'}
							}
						}),
					_1: {ctor: '[]'}
					...
					_0: A2(
						_elm_lang$html$Html$textarea,
						{
							...
							_0: _user$project$Style$class(
								{
									ctor: '::',
									_0: _user$project$Style$InputPane,
									_1: {ctor: '[]'}
								}),
							_1: {
								ctor: '::',
								_0: _elm_lang$html$Html_Events$onInput(_user$project$Explorer$UpdateInput),
								_1: {ctor: '[]'}
							}
						},
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text(_p7.input),
							_1: {ctor: '[]'}
						}),
					_1: {ctor: '[]'}
				}),
				...
				_0: A2(
					...
					},
					{
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _user$project$Explorer$statusMessage(_p8),
								_1: {ctor: '[]'}
							}),
						_1: {
							ctor: '::',
								...
								_elm_lang$html$Html$pre,
								{
									...
									_0: _user$project$Style$class(
										A2(
											...
											{
												ctor: '::',
												_0: _user$project$Style$OutputPane,
												_1: {ctor: '[]'}
											},
											_user$project$Explorer$highlightClass(_p8))),
									_1: {ctor: '[]'}
								},
								{
									ctor: '::',
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_community$html_extra$Html_Attributes_Extra$innerHtml(_p7.parse),
											_1: {ctor: '[]'}
										},
										{ctor: '[]'}),
									_1: {ctor: '[]'}
...
var _user$project$Explorer$main = _elm_lang$html$Html$program(
	{
		init: {
			ctor: '_Tuple2',
			_0: A3(_user$project$Explorer$Model, _user$project$Explorer$initialInput, '', _user$project$Explorer$ParseBad),
			_1: _user$project$Explorer$submitPost(_user$project$Explorer$initialInput)
		},
		update: _user$project$Explorer$update,
		subscriptions: _user$project$Explorer$subscriptions,
		view: _user$project$Explorer$view
	})();

var Elm = {};
Elm['Explorer'] = Elm['Explorer'] || {};
if (typeof _user$project$Explorer$main !== 'undefined') {
    _user$project$Explorer$main(Elm['Explorer'], 'Explorer', undefined);
}
